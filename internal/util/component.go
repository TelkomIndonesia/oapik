...
func (c Components) replaceRootNodes(docv3 *libopenapi.DocumentModel[v3.Document]) (err error) {
	y, err := c.toYamlNode()
	if err != nil {
...
func (c Components) RenderAndReloadWith(doc libopenapi.Document) (b []byte, ndoc libopenapi.Document, docv3 *libopenapi.DocumentModel[v3.Document], err error) {
	docv3, errs := doc.BuildV3Model()
	if err := errors.Join(errs...); err != nil {
		return nil, nil, nil, fmt.Errorf("fail to build v3 model: %w", err)
	}
	b, err = c.RenderWith(docv3)
	if err != nil {
...
func (c Components) RenderWith(docv3 *libopenapi.DocumentModel[v3.Document]) ([]byte, error) {
...
func (c Components) toYamlNode() (n *yaml.Node, err error) {
